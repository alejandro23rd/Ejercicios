...
var paddleX = (canvas.width-paddleWidth)/2;  /*indica el inicio del rectangulo*/
...
var brickOffsetTop = 50; /*indica la separacion del la primera fila con la parte superior*/
var brickOffsetLeft = 23; /*indica la separacion del la primera columna con la parte sderecha*/
...
/*Cuando pulsamos una tecla se ejecuta keyDownHandler(e) y keyUpHandler(e), que pone en la variable "e"
los datos que necesitamos. Efectivamente, e.keyCode nos va a decir qué tecla se ha pulsado.
...
/* funcion que detecta las colisiones y va eliminando cubos, si rompes todos salta el mensaje de HAS GANADO*/
...
function draw() {
    ...
    /* Cuando la distancia entre el centro de la bola y el borde de la pared es exactamente
    igual que el radio de la pelota, cambiará la dirección del movimiento. Restando el radio
    de un ancho del eje y añadiéndolo al otro nos da la impresión de una adecuada detección de
    colisiones - la pelota rebota de las paredes como debería hacerlo.  */
    ...
    Si se pulsa la flecha derecha, se moverá 7 píxeles a la derecha. Podemos mejorar
    esto para que se mueva dentro de los límites del canvas poniendo el limitador*/
